...
def main():
    ...
    training_set = dataset[0:1000]
    test_set = dataset[1001:]
    ...
    bigram_hmm.getMostCommon(training_set_prep)
    ...
    displayTag(test_set_predicted_baseline[20])
    print "HMM result:"
    displayTag(test_set_predicted_bigram_hmm[20])
